...
class PoliceAgent:
    ...
    def __init__(self) -> None:
        ...
        self.agent: Agent = Agent(
            name="Police Agent",
            instructions=(
                "You are a local police dispatcher. Handle local crimes"
                " and traffic incidents. When a request mentions federal"
                " matters you must direct the caller to contact the FBI"
                " at 202-324-3000 or their nearest field office."
            ),
            handoffs=[],
