"""Greetings agent executor with tool-call streaming."""
...
class GreetingsAgentExecutor(AgentExecutor):
    """Adapter used by the A2A DefaultRequestHandler."""

    def __init__(self) -> None:
        """Initialise the Greetings agent executor."""
        self.agent = GreetingsAgent()
    ...
    async def cancel(self, context: RequestContext, event_queue: EventQueue) -> None:
        msg = "Cancellation is not supported for GreetingsAgent"
