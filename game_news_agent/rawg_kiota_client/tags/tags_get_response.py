...
@dataclass
class TagsGetResponse(AdditionalDataHolder, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> TagsGetResponse:
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "results": lambda n : setattr(self, 'results', n.get_collection_of_object_values(Tag)),
        }
        return fields
