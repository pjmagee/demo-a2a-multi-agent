...
if TYPE_CHECKING:
    from ...models.tag_single import TagSingle
...
class TagsItemRequestBuilder(BaseRequestBuilder):
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[TagSingle]:
        """
        Get details of the tag.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[TagSingle]
        """
        ...
        return await self.request_adapter.send_async(request_info, TagSingle, None)
