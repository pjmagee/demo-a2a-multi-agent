...
@dataclass
class PersonSingle(AdditionalDataHolder, Parsable):
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> PersonSingle:
        """
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "rating": lambda n : setattr(self, 'rating', n.get_str_value()),
            "rating_top": lambda n : setattr(self, 'rating_top', n.get_int_value()),
            "reviews_count": lambda n : setattr(self, 'reviews_count', n.get_int_value()),
