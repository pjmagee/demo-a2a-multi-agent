...
if TYPE_CHECKING:
    from .marine_forecastday_day_condition import Marine_forecastday_day_condition

@dataclass
class Marine_forecastday_day(AdditionalDataHolder, Parsable):
    ...
    condition: Optional[Marine_forecastday_day_condition] = None
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> Marine_forecastday_day:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: Marine_forecastday_day
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return Marine_forecastday_day()
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "condition": lambda n : setattr(self, 'condition', n.get_object_value(Marine_forecastday_day_condition)),
