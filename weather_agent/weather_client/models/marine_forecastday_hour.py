...
if TYPE_CHECKING:
    from .marine_forecastday_hour_condition import Marine_forecastday_hour_condition

@dataclass
class Marine_forecastday_hour(AdditionalDataHolder, Parsable):
    ...
    condition: Optional[Marine_forecastday_hour_condition] = None
    ...
    # The sig_ht_mt property
    sig_ht_mt: Optional[float] = None
    # The swell_dir property
    swell_dir: Optional[float] = None
    # The swell_dir_16_point property
    swell_dir_16_point: Optional[float] = None
    # The swell_ht_ft property
    swell_ht_ft: Optional[float] = None
    # The swell_ht_mt property
    swell_ht_mt: Optional[float] = None
    # The swell_period_secs property
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> Marine_forecastday_hour:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: Marine_forecastday_hour
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return Marine_forecastday_hour()
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "condition": lambda n : setattr(self, 'condition', n.get_object_value(Marine_forecastday_hour_condition)),
            ...
            "sig_ht_mt": lambda n : setattr(self, 'sig_ht_mt', n.get_float_value()),
            "swell_dir": lambda n : setattr(self, 'swell_dir', n.get_float_value()),
            "swell_dir_16_point": lambda n : setattr(self, 'swell_dir_16_point', n.get_float_value()),
            "swell_ht_ft": lambda n : setattr(self, 'swell_ht_ft', n.get_float_value()),
            "swell_ht_mt": lambda n : setattr(self, 'swell_ht_mt', n.get_float_value()),
            "swell_period_secs": lambda n : setattr(self, 'swell_period_secs', n.get_float_value()),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_float_value("sig_ht_mt", self.sig_ht_mt)
        writer.write_float_value("swell_dir", self.swell_dir)
        writer.write_float_value("swell_dir_16_point", self.swell_dir_16_point)
        writer.write_float_value("swell_ht_ft", self.swell_ht_ft)
        writer.write_float_value("swell_ht_mt", self.swell_ht_mt)
        writer.write_float_value("swell_period_secs", self.swell_period_secs)
